        ...
        children: [
          Column(
            children: [
              ...
              Container(padding: const EdgeInsets.fromLTRB(20, 0, 20, 0), child: TextField()),
              const SizedBox(
                height: 20,
              ),
              Center(
              ...
              Container(
                ...
                child: PageView.builder(
                  ...
                  controller: PageController(
                    initialPage:
                        selectedQueryIndex, // Set the initial page
                    viewportFraction:
                        1.0, // Display one page at a time
                  ...
                  itemBuilder: (context, index) {
                    return Padding(
                      ...
                      child: Container(
                        ...
                        color: Colors.greenAccent, // Background color for the selected query
                        child: Center(
                          child: Text(
                            queries[index],
